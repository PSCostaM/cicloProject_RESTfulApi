...
public class CicloviaController {
	...
	public ResponseEntity<Ciclovia> getCicloviaById(@RequestParam Long cicloviaId) {
	...
	public ResponseEntity<Calificacion> getCalificacionxCicloviaId(@PathVariable Long cicloviaId,
	...
	public ResponseEntity<Calificacion> createCalificacion(@PathVariable Long cicloviaId,
